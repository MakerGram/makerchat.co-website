...
export const metadata: Metadata = {
	title: `${placesData.details.hyderabad.location} Events`,
	description: `Discover events and updates in ${placesData.details.hyderabad.location}.`,
	icons: {
		icon: [
		...
		<>
			<div className="relative h-[80vh] overflow-hidden">
				...
				<div className="absolute flex items-center flex-col-reverse md:flex-col-reverse justify-center z-50 top-1/2 md:top-1/2  -translate-y-1/2 left-1/2 transform -translate-x-1/2 w-full px-4">
					...
					<div className="text-6xl md:text-[8rem] font-bold font-ocean text-[#FFE19F]">
						HYDERABAD
					</div>
				</div>
			</div>

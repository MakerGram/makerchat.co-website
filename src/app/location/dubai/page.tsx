...
export const metadata: Metadata = {
	title: `${placesData.details.dubai.location} Events`,
	description: `Discover events and updates in ${placesData.details.dubai.location}.`,
	icons: {
		icon: [
		...
		<>
			<div className="relative h-[80vh] overflow-hidden">
				...
				<div className="absolute flex items-center flex-col-reverse md:flex-col-reverse justify-center z-50 top-1/2 md:top-1/2  -translate-y-1/2 left-1/2 transform -translate-x-1/2 w-full px-4">
					...
					<div className="text-8xl md:text-[10rem] font-bold font-yultan bg-gradient-to-r from-[#FFD700] via-[#fdf68c] to-[#fffbe6] bg-clip-text text-transparent">
						Dubai
					</div>
				</div>
			</div>
